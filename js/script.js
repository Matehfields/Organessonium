...
const I18N = {
    'pt-BR': {
        ...
        flow1Text:'Você informa apenas o token do bot. O app procura automaticamente os canais necessários no servidor.',
    ...
    en: {
        ...
        flow1Text:'You only provide the bot token. The app automatically finds the required channels in the server.',
