...
const I18N = {
    'pt-BR': {
        ...
        flow1Text:'Você cola apenas o token do bot; o Organessônium encontra sozinho os canais necessários no servidor.',
    ...
    en: {
        ...
        flow1Text:'You only paste the bot token; Organessônium finds the required server channels by itself.',
